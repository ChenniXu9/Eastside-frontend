    ...
    return (
        <div className="flex flex-col gap-6">
            <div className='p-4 bg-white rounded-lg shadow-md text-lg flex flex-col gap-4'>   
                <div className="">
                    <Link href={`/dashboard/channels/currentChannel/${channel.id}/${userId}`}>
                        <button>
                    ...
                    {joinedChannels.map((channel) => (
                        <li key={channel.id}>
                            <div className="flex justify-between">
                                <Link href={`/dashboard/channels/currentChannel/${channel.id}/${userId}`}className="flex items-center gap-4 p-2 rounded-lg hover:bg-slate-100">
                                    ...
                                    />
                                    <span className="font-semibold font-medium">{channel.channel_name}</span>
                                </Link>
                                <Link href="">
